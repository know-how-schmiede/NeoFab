...
from plotter_utils import plotter_poster_costs
from models import (
    Color,
    CostCenter,
    Material,
...
def create_admin_blueprint(get_translator: Callable[[], Optional[Callable[[str], str]]]) -> Blueprint:
    ...
    def _delete_order_from_database(order: Order) -> dict[str, int]:
        ...
        deleted_counts = {
            ...
            "order_appointment_requests": OrderAppointmentRequest.query.filter_by(order_id=order_id).delete(synchronize_session=False),
            ...
            "order_videos": OrderVideo.query.filter_by(order_id=order_id).delete(synchronize_session=False),
    ...
    def _cost_center_orders_with_costs(cost_center_id: int):
        ...
        for order in cost_center_orders:
            ...
            for poster in order.poster_files:
                order_total_cost += float(plotter_poster_costs(poster)["total_cost"] or 0)
